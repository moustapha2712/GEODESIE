...
"""
    ...
    :license: BSD, LICENSE for more details.
"""
import re
import os
import posixpath
...
[docs]def get_current_url(environ, root_only=False, strip_querystring=False,
...
[docs]def get_host(environ, trusted_hosts=None):
...
[docs]def pop_path_info(environ, charset='utf-8', errors='replace'):
...
[docs]def peek_path_info(environ, charset='utf-8', errors='replace'):
...
[docs]def extract_path_info(environ_or_baseurl, path_or_url, charset='utf-8',
...
[docs]class SharedDataMiddleware(object):
...
[docs]    def __init__(self, app, exports, disallow=None, cache=True,
...
[docs]    def is_allowed(self, filename):
...
[docs]    def get_file_loader(self, filename):
        return lambda x: (os.path.basename(filename), self._opener(filename))


[docs]    def get_package_loader(self, package, package_path):
...
[docs]    def get_directory_loader(self, directory):
        def loader(path):
            if path is not None:
...
[docs]    def generate_etag(self, mtime, file_size, real_filename):
...
[docs]class DispatcherMiddleware(object):
...
[docs]    def __init__(self, app, mounts=None):
        self.app = app
...
[docs]    def __init__(self, iterable, callbacks=None):
...
[docs]def wrap_file(environ, file, buffer_size=8192):
...
[docs]    def __init__(self, file, buffer_size=8192):
        self.file = file
...
[docs]def make_line_iter(stream, limit=None, buffer_size=10 * 1024,
                   cap_at_buffer=False):
...
@implements_iterator
[docs]class LimitedStream(object):
...
[docs]    def __init__(self, stream, limit):
...
[docs]    def exhaust(self, chunk_size=1024 * 64):
...
[docs]    def readlines(self, size=None):
